...
public enum ApprovalStatusApi {
  ...
  ApprovalStatusApi(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ApprovalStatusApi fromValue(String value) {
    for (ApprovalStatusApi b : ApprovalStatusApi.values()) {
