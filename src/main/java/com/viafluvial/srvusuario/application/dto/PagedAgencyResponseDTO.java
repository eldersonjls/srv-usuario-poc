...
@Schema(description = "Resposta paginada de agências")
public class PagedAgencyResponseDTO {

    @Schema(description = "Itens da página")
    private List<AgencyDTO> items;
    ...
    public PagedAgencyResponseDTO() {
    }

    public List<AgencyDTO> getItems() {
        return items;
    }

    public void setItems(List<AgencyDTO> items) {
        this.items = items;
    }
